  ...
  try {
    const formHTML = `
      <form id="add-player-form">
        <input type="text" id="name-input" placeholder="Enter player name" required>
        <input type="text" id="position-input" placeholder="Enter player position" required>
        <input type="text" id="team-input" placeholder="Enter player team" required>
